...
public class Appointment {
    private static int nextAppointmentID = 1;  // as an example only, fix this when working with existing data.
    ...
    // Constructor
    public Appointment(Service service, Staff staff, ZonedDateTime appointmentTimestamp, int appointmentPrice, int appointmentProfitRate) {
